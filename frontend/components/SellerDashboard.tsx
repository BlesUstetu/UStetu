  ...
  return (
    <section className="seller-dashboard">
      <style jsx global>{`
        ...
        .seller-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-bottom:16px}.seller-card{border:1px solid rgba(255,255,255,.1);background:#0a0e19;border-radius:18px;padding:18px;box-shadow:0 10px 35px rgba(0,0,0,.18)}.seller-card label{display:block;font-size:11px;text-transform:uppercase;letter-spacing:.12em;opacity:.55}.seller-value{font-size:24px;font-weight:750;margin-top:8px}.seller-sub{font-size:12px;opacity:.55;margin-top:4px}.seller-ok{color:#75f7ae}.seller-warn{color:#ffd166}
